...
export class ControlsDisplay {
    ...
    build() {
        ...
        secondarySub.add(
            new Button("sub1000", "&minus;10:00", null, () => {
                this.controller.addRemainingSeconds(-600);
            }),
        );
        secondarySub.add(
            new Button("sub500", "&minus;5:00", null, () => {
                this.controller.addRemainingSeconds(-300);
            }),
        );
        secondarySub.add(
            new Button("sub100", "&minus;1:00", null, () => {
                this.controller.addRemainingSeconds(-60);
            }),
            true,
        );
        secondarySub.add(
            new Button("sub30", "&minus;0:30", null, () => {
        ...
        secondaryAdd.add(
            new Button("add1000", "+10:00", null, () => {
                this.controller.addRemainingSeconds(600);
            }),
        );
        secondaryAdd.add(
            new Button("add500", "+5:00", null, () => {
                this.controller.addRemainingSeconds(300);
            }),
        );
        secondaryAdd.add(
            new Button("add100", "+1:00", null, () => {
                this.controller.addRemainingSeconds(60);
            }),
            true,
        );
        secondaryAdd.add(
            new Button("add30", "+0:30", null, () => {
                this.controller.addRemainingSeconds(30);
            }),
        );
...
class Button {
    ...
    build(name: string, text: string, icon: string) {
        ...
        if (!icon) {
            ...
            button.appendChild(
                (
                    document.getElementById(icon) as HTMLTemplateElement
                ).content.cloneNode(true),
            );
